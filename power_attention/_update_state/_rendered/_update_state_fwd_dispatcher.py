...
def _update_state_fwd(K, V, S, deg: tl.constexpr, 
    ...
    block2: tl.constexpr = BLOCK_D // block1
    if ((BLOCK_D == 128) and ((BLOCK_E == 16) and ((block1 == 16) and ((BLOCK_T == 32))))) or (((BLOCK_D == 128) and ((BLOCK_T == 16) and ((BLOCK_E == 16) and ((block1 == 16))))) or (((BLOCK_D == 128) and ((BLOCK_E == 32) and ((block1 == 16) and ((BLOCK_T == 32))))) or (((BLOCK_D == 128) and ((BLOCK_E == 64) and ((block1 == 16) and ((BLOCK_T == 32))))) or (((BLOCK_D == 128) and ((BLOCK_E == 64) and ((BLOCK_T == 16) and ((block1 == 16))))) or ((BLOCK_D == 128) and ((BLOCK_T == 16) and ((BLOCK_E == 32) and ((block1 == 16))))))))):
        ...
        for tid in range(0, tl.cdiv(T, BLOCK_T)):
            ...
            s_0 = tl.dot(k_0.to(K.dtype.element_ty), v, s_0)
            
            s_1 = tl.dot(k_1.to(K.dtype.element_ty), v, s_1)
            
            s_2 = tl.dot(k_2.to(K.dtype.element_ty), v, s_2)
            
            s_3 = tl.dot(k_3.to(K.dtype.element_ty), v, s_3)
            
            s_4 = tl.dot(k_4.to(K.dtype.element_ty), v, s_4)
            
            s_5 = tl.dot(k_5.to(K.dtype.element_ty), v, s_5)
            
            s_6 = tl.dot(k_6.to(K.dtype.element_ty), v, s_6)
            
            s_7 = tl.dot(k_7.to(K.dtype.element_ty), v, s_7)
    ...
    elif ((BLOCK_T == 16) and ((BLOCK_E == 16) and ((block1 == 16) and ((BLOCK_D == 256))))) or (((BLOCK_T == 32) and ((BLOCK_E == 16) and ((block1 == 16) and ((BLOCK_D == 256))))) or (((BLOCK_E == 64) and ((BLOCK_T == 16) and ((block1 == 16) and ((BLOCK_D == 256))))) or (((BLOCK_T == 16) and ((BLOCK_E == 32) and ((block1 == 16) and ((BLOCK_D == 256))))) or (((BLOCK_T == 32) and ((BLOCK_E == 32) and ((block1 == 16) and ((BLOCK_D == 256))))) or ((BLOCK_T == 32) and ((BLOCK_E == 64) and ((block1 == 16) and ((BLOCK_D == 256))))))))):
        ...
        for tid in range(0, tl.cdiv(T, BLOCK_T)):
            ...
            s_8 = tl.dot(k_8.to(K.dtype.element_ty), v, s_8)
            
            s_9 = tl.dot(k_9.to(K.dtype.element_ty), v, s_9)
            
            s_10 = tl.dot(k_10.to(K.dtype.element_ty), v, s_10)
            
            s_11 = tl.dot(k_11.to(K.dtype.element_ty), v, s_11)
            
            s_12 = tl.dot(k_12.to(K.dtype.element_ty), v, s_12)
            
            s_13 = tl.dot(k_13.to(K.dtype.element_ty), v, s_13)
            
            s_14 = tl.dot(k_14.to(K.dtype.element_ty), v, s_14)
            
            s_15 = tl.dot(k_15.to(K.dtype.element_ty), v, s_15)
